...
from hermes.ebnf_grammer import parse_grammer, Grammer
from hermes.first_and_follow import FirstAndFollow
from hermes.lalr1_automata import LALR1Automata, ParseTable, Action
...
def main():
    ...
    parser.add_argument("-n", '--namespace', default="hermes", help="Overrides the namespace, defaults to 'hermes'")
